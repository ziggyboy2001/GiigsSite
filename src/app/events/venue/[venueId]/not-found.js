  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#121212] px-6 text-center text-white">
      ...
      <p className="mt-3 max-w-md text-[#ADB7BE]">
        It may not have any listed shows yet, or the link is incorrect. Discover
        live music happening near you on Giigs.
      </p>
      <div className="mt-6">
        <StoreBadges size={160} location="venue_not_found" />
      </div>
      <Link
        href="/"
