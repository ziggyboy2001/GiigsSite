    ...
    <main className="flex min-h-screen flex-col bg-[#121212]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 py-16 max-w-4xl">
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-[#ADB7BE] mb-8">Last updated October 24, 2023</p>
          ...
          <div className="text-[#ADB7BE] space-y-8 leading-relaxed">
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  as any other related products and services that refer or link
                  to these legal terms (the "Legal Terms") (collectively, the
                  "Services").
                </p>
                <p>
                  Giigs is a dynamic mobile platform tailored for musicians and
                  venue owners, seamlessly bridging their unique needs.
                  Musicians can effortlessly create profiles, showcasing their
                  genres, experience, and specialty pieces, enhancing their
                  visibility to potential venues. Venue owners can explore these
                  profiles, pinpointing the perfect talent to enhance their
                  events. Giigs sets the gold standard in the niche of music and
                  venue networking, revolutionizing collaborations in the music
                  industry.
                </p>
                <p>
                  You can contact us by phone at 7702039091, email at
                  support@bcblabs.com, or by mail to 959 Mesa Terrace Drive,
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-blue-400">
                <li>OUR SERVICES</li>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  support@bcblabs.com. If we ever grant you the permission to
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  you cancel the applicable order. We reserve the right to
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  support@bcblabs.com or call us at 7702039091.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  understand that: (1) we may access, make available, and store
            ...
            <section>
              ...
              <p>
                ...
                located in Harris, Texas, and the Parties hereby consent to, and
                ...
                to the Services be commenced more than one (1) year after the
